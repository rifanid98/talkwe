const actionType = {
  ...
  DELETE_CONVERSATION_PENDING: 'DELETE_CONVERSATION_PENDING',
  DELETE_CONVERSATION_REJECTED: 'DELETE_CONVERSATION_REJECTED',
  DELETE_CONVERSATION_FULFILLED: 'DELETE_CONVERSATION_FULFILLED',
};
